                ...
                <div class="d-flex justify-content-between col-sm-3">
                    @can('اضافة منتج')
                        <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-slide-in-right"
                            data-toggle="modal" href="#modaldemo8"><i class="icon icon-plus"
                                style="font-size:8px;margin-left: 8px"></i>اضافة منتج</a>
                    @endcan
                </div>
            </div>
            <div class="card-body">
                        ...
                        <tbody>
                            ...
                            @foreach ($products as $product)
                                <tr>
                                    ...
                                    <td>
                                        @can('تعديل منتج')
                                            <a href="#modaledit" id="edit" class="modal-effect btn btn-info"
                                                data-effect="effect-scale" data-product_id="{{ $product->id }}"
                                                data-section_name="{{ $product->product_name }}"
                                                data-description="{{ $product->description }}"
                                                data-section_product="{{ $product->section->id }}" data-toggle="modal"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                    <form action="{{ route('products') }}" class="form-horizontal" method="POST">
                        @csrf
                        ...
                        <div class="form-group mt-2">
                            ...
                            <select name="section_id" id="section_id" class="form-control nice-select custom-select">
            ...
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                    <form action="{{ route('products') }}" class="form-horizontal" method="POST">
                        ...
                        <div class="form-group">
                            <input type="hidden" class="form-control" name="id" id="product_id_edit">
                        </div>
                        <div class="form-group">
                            <label for="inputNameEdit">اسم المنتج</label>
                            <input type="text" class="form-control" name="productname" id="inputNameEdit"
                                placeholder="اسم المنتج">
                        </div>
                        <div class="form-group mt-2">
                            <label class="form-label" for="sectionedit">القسم</label>
                            <select id="sectionedit" name="section_id" class="form-control nice-select custom-select">
                                @foreach ($sections as $section)
                                    <option value="{{ $section->id }}">{{ $section->section_name }}</option>
                                @endforeach
                            </select>
            ...
            <div class="modal-content modal-content-demo">
                ...
                <div class="modal-body">
                    <form action="{{ route('products') }}" class="form-horizontal" method="POST">
                        ...
                        <div class="form-group">
                            <label for="inputNamedelete">هل انت متاكد من عملية الحذف</label>
    ...
    <script>
        $(document).ready(function() {
            $('a#edit').on('click', function(event) {
                ...
                var sectionproduct = $(this).data('section_product');
                var section_id = $('#product_id_edit');
