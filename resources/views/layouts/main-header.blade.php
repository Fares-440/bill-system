        ...
        <div class="main-header-right">
            ...
            <div class="nav nav-item  navbar-nav-right ml-auto">
                            ...
                            <div class="menu-header-content bg-primary text-right">
                                <div class="d-flex">
                                    ...
                                    <span class="badge badge-pill badge-warning mr-auto my-auto float-left"><a
                                            href="{{route('markup')}}">تعين قراءة الكل</a></span>
                                </div>
                ...
                <div class="dropdown main-profile-menu nav nav-item nav-link">
                    <a class="profile-user d-flex" href=""> <i class="fa fa-user-tie fa-2x text-primary"></i>
                    </a>
                    <div class="dropdown-menu">
                        <div class="main-header-profile bg-primary p-3">
                            <div class="d-flex wd-100p">
                                <div class="bg-white pr-1 pl-1 border border-white rounded-circle"><i
                                        class="fa fa-user-tie fa-2x text-primary"></i>
                                </div>
